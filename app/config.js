...
exports.config.sound_path = "sound/";
exports.config.sound_on = true;
/*
 * DEBUGGING MODE
 * debugState = true; will spit all debuging message inside browser console.
 * The colors are best displayed in chrome browser.
 */
exports.config.debugState = false;
exports.config.debugStyle = 'font-weight: bold; color: #00f;';
exports.config.debugStyle_green = 'font-weight: bold; font-style:italic; color: #46C246;';
exports.config.debugStyle_red = 'font-weight: bold; color: #ed1c24;';
exports.config.debugStyle_warning = 'background-color:yellow';
exports.config.debugStyle_success = 'background-color:green; font-weight:bold; color:#fff;';
exports.config.debugStyle_error = 'background-color:#ed1c24; font-weight:bold; color:#fff;';
exports.config.voice_command = true;
exports.config.voice_command_auto = false;
/*
 ...
 *  Lingua latД«na    ['la']
 */
exports.config.voice_command_lang = 'en-US';
/*
 *  Use localstorage to remember on/off (best used with HTML Version)
 */
exports.config.voice_localStorage = false;
/*
 * Voice Commands
 * Defines all voice command variables and functions
 */
if (exports.config.voice_command) {
    exports.config.commands = {
